...
git clone https://github.com/davecalleja-merkle/test-debug-123.git

# Install all required packages
cd test-debug-123 && pnpm install
...
### First Time Setup
1. **Clone the repository:** `git clone https://github.com/davecalleja-merkle/test-debug-123.git`
2. **Install dependencies:** `cd test-debug-123 && pnpm install`
